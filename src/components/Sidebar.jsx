  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col gap-2 px-4 pb-6 font-medium overflow-y-auto divide-y divide-gray-200">
        <Section title="Fundamentos de Java" icon={<BookOpen size={16} />}>
          <SidebarLink to="/tipos-datos">Tipos de datos</SidebarLink>
        ...
        <Section title="Java Avanzado" icon={<Layers size={16} />}>
        ...
        <Section title="Unit testing" icon={<FlaskConical size={16} />}>
          <SidebarLink to="/testing">JUnit 5 y Mockito</SidebarLink>
        </Section>

        <Section title="Spring framework" icon={<Flower2 size={16} />}>
        ...
        <Section title="Persistencia" icon={<Database size={16} />}>
        ...
        <Section title="Principios SOLID" icon={<ShieldCheck size={16} />}>
          <SidebarLink to="/solid">Principios SOLID</SidebarLink>
        </Section>

        <Section title="Patrones de diseño" icon={<Puzzle size={16} />}>
        ...
        <Section title="APIs RESTful y JSON" icon={<FileCode size={16} />}>
          <SidebarLink to="/rest">APIs RESTful y JSON</SidebarLink>
        </Section>

        <Section title="Seguridad" icon={<ShieldCheck size={16} />}>
          <SidebarLink to="/seguridad-jwt">JWT</SidebarLink>
          <SidebarLink to="/seguridad-oauth">OAuth 2.0</SidebarLink>
        </Section>

        <Section title="Entorno & CI/CD" icon={<Terminal size={16} />}>
        ...
        <Section title="Cloud" icon={<Cloud size={16} />}>
        ...
        <Section title="Otros" icon={<Zap size={16} />}>
        ...
        <Section title="Code challenges" icon={<FileCode size={16} />}>
